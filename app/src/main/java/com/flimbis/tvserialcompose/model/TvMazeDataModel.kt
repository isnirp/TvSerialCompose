package com.flimbis.tvserialcompose.model
...
data class Season(val id: Long, val number: Int, val name: String?, val episodeOrder: Int?, val premiereDate: String?, val endDate: String?,
